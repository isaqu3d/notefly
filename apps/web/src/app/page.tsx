        ...
        <section className="container py-24 md:py-32 lg:py-40">
          <div className="mx-auto flex max-w-[980px] flex-col items-center gap-6 text-center">
            ...
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
              Write, plan, share.
              <br />
              <span className="text-muted-foreground">With AI at your side.</span>
            </h1>

            <p className="max-w-[700px] text-lg text-muted-foreground sm:text-xl">
              Notely is the connected workspace where better, faster work happens.
              A beautiful, minimal editor with powerful blocks.
            </p>
          ...
          <div className="mx-auto grid max-w-[1200px] gap-8 md:grid-cols-3">
            <div className="group relative overflow-hidden rounded-lg border bg-card p-6 hover:bg-accent/50 transition-colors">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Rich text editing with drag-and-drop blocks. Headings, lists, code blocks, and more.
              </p>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-lg border bg-card p-6 hover:bg-accent/50 transition-colors">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Built on Next.js 15 with optimal performance. Your workspace loads instantly.
              </p>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-lg border bg-card p-6 hover:bg-accent/50 transition-colors">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Organize projects in workspaces. Perfect for teams and personal use.
              </p>
            </div>
          </div>
        </section>
